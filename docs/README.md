...
- URL: https://huggingface.co/spaces/Chris4K/ai-recruitment-system
- SDK: streamlit
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/ai-recruitment-system/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/ai-recruitment-system
